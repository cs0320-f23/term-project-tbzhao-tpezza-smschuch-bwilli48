...
export const mockResorts = [MockA, MockB, MockD, MockC, MockE, MockF, MockG, MockH];

export const mockResortsSort = [MockE, MockF, MockG, MockH, MockA, MockB, MockD, MockC];
...
export function getRankedResorts(prefs: Map<string, PreferenceAndValue>): Resort[] {
	return [];
}
...
export function getMockRankedResorts(prefs: Map<string, PreferenceAndValue>): Resort[] {
...
export const mockResortNames = () => {
	return ["Mock A", "Mock B", "Mock C", "Mock D", "Mock E", "Mock F", "Mock G", "Mock H"];
};

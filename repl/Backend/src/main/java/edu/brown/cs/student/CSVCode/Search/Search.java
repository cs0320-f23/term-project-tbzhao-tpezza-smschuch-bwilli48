package edu.brown.cs.student.CSVCode.Search;
...
public class Search {
  ...
  /**
   * List of list of string of a parsedcsv to search
   */
  ...
  /**
   * String of column identifier
   */
  String columnIdentifier;
  /**
   * Boolean if csv has headers
   */
  Boolean hasHeaders;
  /**
   * Boolean is search checks case
   */
  Boolean checkCase;
